...
class EmployeeTest < ActiveSupport::TestCase
  ...
  test "defines current_versions_dataset" do
    ...
    employee.update_attributes address: "Lake Noramouth 1", valid_from: initial_today+1
    employee.update_attributes address: "Lake Noramouth 2", valid_from: initial_today+2

    versions = employee.versions
    current_version = employee.current_version
    assert versions.size == 3
    assert versions[2].address == "Lake Noramouth 2"
  end
